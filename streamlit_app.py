...
# ===========================
# تنظیمات استایل (CSS) برای راست‌چین سازی کامل
# ===========================
st.markdown("""
<style>
    /* 1. تنظیم فونت و جهت کلی صفحه */
    ...
    /* 3. راست‌چین کردن ورودی‌های متن (Input & Text Area) */
    ...
    /* 5. راست‌چین کردن جدول‌ها (Dataframe) */
    [data-testid="stDataFrame"] {
        direction: rtl;
        text-align: right;
    }
    /* تلاش برای راست‌چین کردن هدرهای جدول */
...
if st.session_state.get("db_ready"):
    ...
    # نکته: در حالت RTL، ستون اول سمت راست قرار می‌گیرد
    ...
    with col2:
        st.markdown("<div style='margin-top: 28px;'></div>", unsafe_allow_html=True) # تراز کردن دکمه
    ...
    if search and query:
        with st.spinner('در حال نوشتن پاسخ...'):
            try:
                ...
                # نمایش جدول با تنظیمات راست‌چین
                st.dataframe(
                    df, 
